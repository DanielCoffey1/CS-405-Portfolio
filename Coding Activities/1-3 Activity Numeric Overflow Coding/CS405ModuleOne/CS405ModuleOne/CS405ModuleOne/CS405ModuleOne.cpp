...
void test_overflow()
{
    ...
    if (result == -1) { // if an overflow occurs
        std::cout << "Error: overflow when adding numbers" << std::endl; // print overflow error
    }
    else {
        std::cout << +result << std::endl; // else - print result
    }
}
...
void test_underflow()
{
    ...
    if (result == -1) { // if an overflow occurs
        std::cout << "Error: Underflow when subtracting numbers" << std::endl; // print overflow error
    }
    else {
        std::cout << +result << std::endl;  // else - print result
    }
